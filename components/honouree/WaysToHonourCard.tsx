'use client'
/* =========================================================
   components/honouree/WaysToHonourCard.tsx
   
   Expression of Honour — Profile Page
   EXACT visual replica of WaysToHonourSection.tsx
   
   Replaces the old white card design.
   Same gold 3-zone layout as the tribute wall version.
   Same backend: capsule_support_accounts table.
   Same DB columns: method_label, account_holder, bank_name,
     account_number, reference_guide, currency, is_active,
     sort_order, relationship_to_honouree
   
   Props:
     accounts[]    — from profile/page.tsx server fetch
     capsuleId     — for acknowledgement API call
     honourName    — honouree_name from capsule
     eventType     — for ceremonial message
   
   No supabase client needed — uses fetch() for notify API.
   Internal names preserved per EOH-01 rule.
   
   Last touched: Claude (AI6) · v1.2.6
========================================================= */
...
/* ── Shared gold theme tokens (mirror WaysToHonourSection) */
const t = {
  accentPrimary: 'rgba(226,195,107,1)',
  accentMuted: 'rgba(226,195,107,0.75)',
  accentFaint: 'rgba(226,195,107,0.35)',
  textHeading: '#f5f0e8',
  textBody: 'rgba(245,240,232,0.85)',
...
/* =========================================================
   ZONE B — Beneficiary Card (identical to WaysToHonourSection)
========================================================= */
      ...
      <div style={{ padding: '16px 18px' }}>
        ...
        {trustStatement && (
          <div style={{
            ...
            border: '1px solid rgba(226,195,107,0.1)',
            marginBottom: '12px',
          }}>
            <p style={{
        ...
        {account.bank_name && (
          <div style={{ marginBottom: '6px' }}>
            <p style={{
              ...
              textTransform: 'uppercase' as const, letterSpacing: '0.1em', marginBottom: '2px',
            }}>Bank</p>
        ...
        {account.account_number && (
          <div style={{ marginBottom: '8px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{
                fontSize: '15px', fontWeight: 700, color: t.accentPrimary,
          ...
          {!revealed ? (
            <button
              ...
              style={{
                ...
                color: t.accentPrimary, fontSize: '12px', fontWeight: 700, cursor: 'pointer',
              }}
            >
              Reveal Details
            </button>
            ...
            <button
              ...
              style={{
                flex: 1, padding: '8px', borderRadius: '10px',
                border: `1px solid ${copied ? 'rgba(74,222,128,0.3)' : 'rgba(226,195,107,0.2)'}`,
                background: copied ? 'rgba(74,222,128,0.07)' : 'rgba(226,195,107,0.05)',
                color: copied ? 'rgba(134,239,172,0.9)' : t.accentMuted,
        ...
        {account.reference_guide && (
          <p style={{
            fontSize: '11px', color: t.textFaint, lineHeight: 1.6,
...
/* =========================================================
   ZONE C — Notify Beneficiary Modal
========================================================= */
function NotifyBeneficiaryModal({
  capsuleId,
  accountId,
  onClose,
}: {
  ...
  return (
    <div
      style={{
        ...
        padding: '16px', background: 'rgba(8,2,20,0.92)', backdropFilter: 'blur(8px)',
      }}
      onClick={onClose}
    >
      <div
        ...
        <div style={{ padding: '24px 20px' }}>
          {done ? (
            <div style={{ textAlign: 'center', padding: '16px 0' }}>
              ...
              <p style={{
                fontSize: '16px', fontWeight: 700, color: t.accentPrimary,
              ...
              <button
                ...
                style={{
                  ...
                  color: '#1a0845', fontSize: '13px', fontWeight: 700, border: 'none', cursor: 'pointer',
                }}
              >
                Close
              </button>
            ...
            <>
              <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                <p style={{
                  fontSize: '16px', fontWeight: 700, color: t.textHeading,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    color: t.textFaint, fontSize: '12px', cursor: 'pointer',
                  }}
                >
                  Cancel
                </button>
...
/* =========================================================
   MAIN EXPORT — 3-Zone Layout (Profile Page)
   
   Drop-in replacement for the old WaysToHonourCard.
   Profile page passes accounts[] already filtered for
   is_active on the server, but we filter again defensively.
========================================================= */
    ...
    <div style={{ marginTop: '24px', marginBottom: '24px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '16px' }}>
        ...
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: '20px',
          boxShadow: '0 0 24px rgba(226,195,107,0.12)',
        }}>
          ✦
        </div>
        ...
        <p style={{
          ...
          textTransform: 'uppercase' as const, color: t.accentMuted, marginBottom: '8px',
        }}>
          Expression of Honour
        </p>
        <p style={{
          fontSize: '13px', color: t.textFaint, lineHeight: 1.7,
          maxWidth: '320px', margin: '0 auto', fontStyle: 'italic',
        }}>
          {ceremonialMessage}
        </p>
        ...
        <div style={{
          height: '1px',
          background: 'linear-gradient(to right, transparent, rgba(226,195,107,0.2), transparent)',
          marginTop: '16px',
        }} />
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: '14px' }}>
        <p style={{
          fontSize: '11px', color: t.textFaint, lineHeight: 1.65,
          maxWidth: '300px', margin: '0 auto 12px', fontStyle: 'italic',
        }}>
          If you have shared an Expression of Honour, you may notify the beneficiary so that your gesture can be properly acknowledged.
        </p>
        <button
          ...
          style={{
            ...
            background: 'rgba(226,195,107,0.08)',
            color: t.accentPrimary, fontSize: '13px', fontWeight: 700,
