...
// Purpose: Approve a community-proposed topic
// Auth: Organiser email verified against capsule
// AI10 · June 2026
// ============================================================
// NOTE: Place this code in a separate file at the path above.
// Exported separately here for sprint delivery.

export async function APPROVE_TOPIC(req: NextRequest, topicId: string) {
  try {
