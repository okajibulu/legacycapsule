      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{ maxWidth: '560px', width: '100%', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.8, marginBottom: '36px' }}>
            We start every capsule free — your tribute wall is live in minutes at no cost. From there, you choose
            exactly what your event needs: photo tributes, audio and video contributions, digital publication,
            extended validity, guest coordination, and more. Component by component. No waste. Contact us to
            discuss what your event requires.
          </p>
