      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{ maxWidth: '560px', width: '100%', textAlign: 'center' }}>
          ...
          <h1 style={{
            ...
            Build your network. Grow with us.
          </h1>

          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.65)', lineHeight: 1.65, marginBottom: '20px', fontWeight: 500 }}>
            Become a certified LegacyCapsule reseller and earn by introducing the platform to your community.
          </p>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.8, marginBottom: '36px' }}>
            Our reseller programme is designed for professionals, community leaders, and entrepreneurs who want to
            build a sustainable business introducing LegacyCapsule to clients, event planners, and families in their
            network. Certification, territory support, and a dedicated reseller dashboard — coming soon.
          </p>

          <a href="mailto:resellers@itslegacycapsule.com" style={{
